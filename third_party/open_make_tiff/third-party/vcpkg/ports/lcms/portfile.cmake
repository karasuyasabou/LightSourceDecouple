...
# Remove shared pthread flags for static MinGW builds
vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/lib/pkgconfig/lcms2.pc" " -pthread" "")
if(EXISTS "${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/lcms2.pc")
    vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/lcms2.pc" " -pthread" "")
endif()
